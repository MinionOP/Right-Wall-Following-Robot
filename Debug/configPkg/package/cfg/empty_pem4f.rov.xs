...
__obj = [
    ...
    {},    // #687 ti.sysbios.knl.Swi.Instance#1
    {},    // #688 ti.sysbios.knl.Swi.Instance#1/instance
...
__o = __obj[686]  // ti.sysbios.knl.Swi.Instance#0/instance
    ...
    __o['name'] = String(java.net.URLDecoder.decode('toDoHandle', 'UTF-8'))

__o = __obj[687]  // ti.sysbios.knl.Swi.Instance#1
    __o['$category'] = String(java.net.URLDecoder.decode('Instance', 'UTF-8'))
    __o['$module'] = __obj[683.0]
...
__o = __obj[688]  // ti.sysbios.knl.Swi.Instance#1/instance
    __o['$category'] = String(java.net.URLDecoder.decode('Struct', 'UTF-8'))
